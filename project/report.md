...
- **Ссылка на репозиторий:** `https://github.com/KiriII007/aie-group`
...
1. **Источник данных:**
   - **Для детекции и параметризации:** открытый датасет Humans (> 3000 лиц анфас). Ссылка: https://www.kaggle.com/datasets/ashwingupta3012/human-faces/discussion/333494
...
2. **Улучшенные модели и эксперименты: (`notebooks/dpo_train.ipynb`)**
   ...
   - **RLAIF пайплайн:** генерация 3 вариантов на запрос → оценка каждого через LLaVA → выбор. Пользователь получает лучший вариант.
